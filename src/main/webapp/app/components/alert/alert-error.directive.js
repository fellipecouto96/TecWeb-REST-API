(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('tecWebRestApiApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-tecWebRestApiApp-error');
                var entityKey = httpResponse.headers('X-tecWebRestApiApp-params');
                if (errorHeader) {
