(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('tecWeb04ApiApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-tecWeb04ApiApp-error');
                var entityKey = httpResponse.headers('X-tecWeb04ApiApp-params');
                if (errorHeader) {
