...
public class RelatorioEventoDTO implements Serializable {
	...
	private List<ClienteIngressoRelatorioDTO> listaClienteIngresso;
	...
	public List<ClienteIngressoRelatorioDTO> getListaClienteIngresso() {
		return listaClienteIngresso;
	}
	public void setListaClienteIngresso(List<ClienteIngressoRelatorioDTO> listaClienteIngresso) {
