...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "TecWeb04API@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "TecWeb04API API";

        private String description = "TecWeb04API API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "TecWeb04API";
